<?php 
	class Personas_modelo{
		...
		public function getRegistros(){
			...
			#$consulta=$this->db->query("SELECT * FROM dbpreguntadevs.tbpersona LIMIT $empezar_desde, $tamanoPaginas");
			$consulta=$this->db->query("SELECT * FROM TBPERSONA LIMIT $empezar_desde, $tamanoPaginas");
