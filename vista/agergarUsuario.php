...
<body class="">
	...
	<section class="container">
		...
		if (isset($_POST["guardar"])){
			...
			$sentenciaSQL="INSERT INTO tbusuarios(`usuarioId`, `nombre1`, `nombre2`, `apellido1`, `apellido2`, `claveSeguridad`) VALUES ('".$usuarioId."','".$nombre1."','".$nombre2."','".$apellido1."','".$apellido2."','".$claveSeguridad."');";
echo $sentenciaSQL;
