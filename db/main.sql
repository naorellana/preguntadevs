...
CREATE OR REPLACE TABLE BITPREGUNTAS(
	IDPREGUNTA 	INT NOT NULL,
	RESPENVIADA 	INT NOT NULL,
	RESPCO INT NOT NULL,
	USUARIO VARCHAR(20) NOT NULL,
	FECHA DATE,
	FOREIGN KEY (IDPREGUNTA) REFERENCES PREGUNTAS(IDPREGUNTA),
	FOREIGN KEY (USUARIO) REFERENCES TBPERSONA(USUARIO)
	)

SELECT COUNT(*) FROM `bitpreguntas` WHERE USUARIO='norellanac' and RESPENVIADA=RESPCO;

/*consulta de 10 preguntas aleatorias 
	SELECT * FROM `preguntas` WHere nivel=2 and etiqueta=3 ORDER BY rand() LIMIT 5
*/
SELECT * FROM `preguntas` WHere nivel=2 and etiqueta=3 ORDER BY rand() LIMIT 5


CREATE OR REPLACE TABLE BITLOGUEOS(
	USUARIO VARCHAR(20) NOT NULL,
	FECHA DATE NOT NULL,
	ACCION INT NOT NULL,
	FOREIGN KEY (USUARIO) REFERENCES TBPERSONA(USUARIO)
